...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\laragon\www\EduArchive\public\storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.D:\\laragon\\www\\EduArchive\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'tenancy.migration_parameters.--force','tenancy.migration_parameters.--path','tenancy.migration_parameters.--realpath','tenancy.seeder_parameters.--class','excel.exports.chunk_size',
...
'stancl.tenancy.asset','dashboard','profile.edit',
'profile.update','profile.destroy','superadmin.dashboard','superadmin.tenants.index','superadmin.tenants.create',
'superadmin.tenants.store','superadmin.tenants.show','superadmin.tenants.edit','superadmin.tenants.update','superadmin.tenants.destroy',
'superadmin.tenants.status','superadmin.monitoring.index','superadmin.monitoring.print_recap','superadmin.monitoring.school','superadmin.monitoring.student',
'superadmin.monitoring.access_document','superadmin.monitoring.document_access.request','superadmin.monitoring.audit_logs','superadmin.broadcasts.index','superadmin.broadcasts.create',
'superadmin.broadcasts.store','superadmin.broadcasts.destroy','superadmin.settings.index','superadmin.settings.update','superadmin.roles.index',
'superadmin.roles.create','superadmin.roles.store','superadmin.roles.show','superadmin.roles.edit','superadmin.roles.update',
'superadmin.roles.destroy','superadmin.users.index','superadmin.users.create','superadmin.users.store','superadmin.users.show',
'superadmin.users.edit','superadmin.users.update','superadmin.users.destroy','adminlembaga.dashboard','adminlembaga.teachers.template',
'adminlembaga.teachers.import','adminlembaga.teachers.index','adminlembaga.teachers.create','adminlembaga.teachers.store','adminlembaga.teachers.show',
'adminlembaga.teachers.edit','adminlembaga.teachers.update','adminlembaga.teachers.destroy','adminlembaga.classrooms.index','adminlembaga.classrooms.create',
'adminlembaga.classrooms.store','adminlembaga.classrooms.show','adminlembaga.classrooms.edit','adminlembaga.classrooms.update','adminlembaga.classrooms.destroy',
'adminlembaga.students.template','adminlembaga.students.import','adminlembaga.students.index','adminlembaga.students.create','adminlembaga.students.store',
'adminlembaga.students.show','adminlembaga.students.edit','adminlembaga.students.update','adminlembaga.students.destroy','adminlembaga.documents.index',
'adminlembaga.documents.create','adminlembaga.documents.store','adminlembaga.documents.destroy','adminlembaga.school-documents.index','adminlembaga.school-documents.create',
'adminlembaga.school-documents.store','adminlembaga.school-documents.destroy','adminlembaga.reports.index','operator.dashboard','register','login','password.request','password.email',
...
'auth.verify-email','backend.adminlembaga.classrooms.create','backend.adminlembaga.classrooms.edit','backend.adminlembaga.classrooms.index','backend.adminlembaga.dashboard',
'backend.adminlembaga.documents.create','backend.adminlembaga.documents.index','backend.adminlembaga.reports.index','backend.adminlembaga.school_documents.index','backend.adminlembaga.students.create',
'backend.adminlembaga.students.edit','backend.adminlembaga.students.import_modal','backend.adminlembaga.students.index','backend.adminlembaga.teachers.create','backend.adminlembaga.teachers.edit',
'backend.adminlembaga.teachers.import_modal','backend.adminlembaga.teachers.index','backend.layouts.app','backend.layouts.partials.footer','backend.layouts.partials.navbar',
'backend.layouts.partials.sidebar','backend.operator.dashboard','backend.superadmin.broadcasts.create','backend.superadmin.broadcasts.index','backend.superadmin.dashboard',
'backend.superadmin.monitoring.audit_logs','backend.superadmin.monitoring.index','backend.superadmin.monitoring.print_recap','backend.superadmin.monitoring.student_detail','backend.superadmin.monitoring.students',
'backend.superadmin.roles.create','backend.superadmin.roles.edit','backend.superadmin.roles.index','backend.superadmin.settings.index','backend.superadmin.tenants.create',
'backend.superadmin.tenants.edit','backend.superadmin.tenants.index','backend.superadmin.users.create','backend.superadmin.users.edit','backend.superadmin.users.index',
...
'D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'D:.laragon.www.EduArchive.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
