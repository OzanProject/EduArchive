<section class="py-20 px-6 md:px-20">
  <div
    class="max-w-5xl mx-auto bg-gradient-to-r from-primary to-blue-700 rounded-[2.5rem] p-12 md:p-20 text-center relative overflow-hidden shadow-2xl shadow-primary/30">
      ...
      <div class="flex flex-wrap justify-center gap-4">
        ...
        @else
          <a href="{{ route('register') }}"
            class="px-8 py-4 bg-white text-primary font-bold rounded-xl shadow-xl shadow-black/10 hover:bg-slate-50 transition-colors">Daftarkan
            Instansi Anda</a>
        @endauth
        <button
