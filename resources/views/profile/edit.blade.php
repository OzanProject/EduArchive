...
@section('page_title', 'Profile User')
        ...
        <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                    ...
                    <p class="text-muted text-center">@if($user->role === 'superadmin')
                        Super Administrator
                ...
                <div class="card-body">
                    <div class="tab-content">
                        ...
                        <div class="active tab-pane" id="settings">
                            @php
                                $updateRoute = auth()->user()->role === 'superadmin' ? route('profile.update') : route('tenant.profile.update');
                            @endphp
                            <form method="post" action="{{ $updateRoute }}" class="form-horizontal"
                        ...
                        <div class="tab-pane" id="password">
                            @php
                                $passwordRoute = auth()->user()->role === 'superadmin' ? route('password.update') : route('tenant.password.update');
                            @endphp
                            <form method="post" action="{{ $passwordRoute }}" class="form-horizontal">
                                @csrf
                                @method('put')
